							...
							<form>
							  ...
							  <div class="form-row">
								  ...
								  <div class="form-group col-md-4">
									<label for="itemDetailsExpireDate">Expire Date<span class="requiredIcon">*</span></label>
									<input type="date" class="form-control" name="itemDetailsExpireDate" id="itemDetailsExpireDate" autocomplete="off" required min="<?=date("Y-m-d")?>">
									<div id="itemDetailsExpireDateSuggestionsDiv" class="customListDivWidth"></div>
								  </div>
							  </div>
							  <div class="form-row">
